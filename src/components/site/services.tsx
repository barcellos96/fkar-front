...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      <span className="flex items-center gap-3 text-lg font-light mb-8 lg:mb-16 text-zinc-600">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 px-6 max-w-7xl md:max-w-5xl">
        <div className="flex flex-col items-center p-4 px-10 bg-zinc-100 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <Fuel className="text-green-700 mb-2" size={32} />
          <p className="text-center text-zinc-700 font-medium uppercase">
            Cadastro de Abastecimento
          </p>
          <p className="text-center text-zinc-500 text-base mt-3">
      ...
      <div className="flex flex-col pb-10 items-center justify-center w-full bg-gradient-radial from-green-100 to-white my-20">
        ...
        <button
          ...
          className="flex items-center justify-center max-w-[300px] gap-2 bg-transparent border border-green-700 font-bold text-green-700 shadow-lg w-96 py-2 rounded-xl hover:bg-green-700 hover:text-white"
        >
